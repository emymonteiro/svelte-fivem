		...
		<div class="flex w-full gap-4">
			<div class="flex flex-col w-2/3 p-4">
				<div class="flex flex-row w-full text-sm">
					<div class="flex flex-col flex-1">
						...
						<p class="text-light text-xs">{item.description}</p>
						<span class="mt-auto">{item.type}</span>
					</div>
					<img class="w-25 h-25" src={item.img} alt={item.name} />
				</div>
				<div class="flex flex-col w-full">
					...
					<div
						...
						class:drop-shadow-uncommon={item.rarity === "uncommon"}
						class:drop-shadow-legendary={item.rarity ===
							"legendary"}
					>
						<span class="text-xs font-bold"> {item.rarity} </span>
						<div
							...
							class:before:bg-common={item.rarity === "common"}
							class:after:bg-common={item.rarity === "common"}
							class:before:bg-uncommon={item.rarity ===
								"uncommon"}
							class:after:bg-uncommon={item.rarity === "uncommon"}
			...
			<div class="flex flex-col w-1/3 gap-4 p-4">
				<div class="flex flex-col gap-2">
					...
					<ul class="text-[0.65rem] flex flex-col text-light gap-1">
